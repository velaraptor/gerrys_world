...
## Roadmap
Currently the app is being hosted @ https://christophvel.shinyapps.io/gerrys_world
...
## Development
To start this Shiny App on your local computier, first make sure you have gdal installed.
```
brew install gdal
```
